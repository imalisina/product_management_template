<aside class="w-60 h-screen">
    <div class="h-full px-6 py-4 overflow-y-auto bg-green-10">
        <ul class="space-y-2">
            <li>
                <a href="" class="mt-2 mb-2 flex items-center p-2 text-base font-normal text-gray-900 rounded-lg <?php $_SERVER["PHP_SELF"] == "/product_management_template/admin/index.php" ? print("bg-green-100") : print("hover:bg-gray-100") ?>">
                ...
                <a href="" class="mt-2 mb-2 flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100">
                    <svg class="w-6 h-6 text-gray-500" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
